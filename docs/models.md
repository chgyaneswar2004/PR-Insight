...
CodeWatch 支持多种 AI 模型，可以根据需要选择不同的模型进行代码评估和分析。
...
```bash
python run_codewatch_eval.py "开发者名称" --model gpt-4o
```
...
```bash
python run_codewatch_eval.py "开发者名称" --model gpt-4-turbo
python run_codewatch_eval.py "开发者名称" --model gpt-3.5-turbo-16k
python run_codewatch_eval.py "开发者名称" --model gpt-4o-mini
```
...
```bash
# 使用 GPT-4o 评估代码
python run_codewatch_eval.py "开发者名称" --model gpt-4o --tokens-per-minute 6000 --max-concurrent 2

# 使用简写形式
python run_codewatch_eval.py "开发者名称" --model 4o
```
