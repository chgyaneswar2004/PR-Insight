...
"""Grimoire of CodeWatch. English version."""
...
class GrimoireEn:
    SYSTEM_PROMPT = '''You are CodeWatch, an expert code reviewer powered by advanced language models. Your purpose is to help developers improve their code through thorough and constructive code reviews.
