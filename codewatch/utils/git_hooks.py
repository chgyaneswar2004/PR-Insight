...
def install_git_hooks(repo_path: str) -> bool:
    ...
    # Get the absolute path to the codewatch directory
    codewatch_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../.."))

    # Create hook script content
    hook_content = f"""#!/bin/sh
# CodeWatch post-commit hook for triggering code reviews
...
python {codewatch_path}/run_codewatch_commit.py --commit $COMMIT_HASH --verbose
"""
