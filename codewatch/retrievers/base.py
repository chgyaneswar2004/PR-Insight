...
from codewatch.models import Blob, ChangeFile, Commit, PullRequest, Repository
...
class Retriever(ABC):
    ...
    Github, Gitlab, Bitbucket etc. It defines the interface codewatch uses to retrieve data from
