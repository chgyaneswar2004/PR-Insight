...
from codewatch.models.diff import DiffSegment
from codewatch.retrievers.base import Retriever
from codewatch.utils.diff_utils import parse_patch_file
...
class GithubRetriever(Retriever):
    ...
    def _build_pull_request(self, git_pr: GHPullRequest) -> PullRequest:
        ...
        # Fallback if the head (source) repository was deleted
        head_repo = git_pr.head.repo if git_pr.head.repo else git_pr.base.repo
        ...
        return PullRequest(
            ...
            url=git_pr.html_url,
            repository_name=head_repo.full_name,
